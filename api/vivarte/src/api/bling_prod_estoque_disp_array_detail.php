...
if ($processar_carteira) {
    ...
    if ($api_qtde_pedido == 0) {
        ...
        $carteira_processada = '
			...
			<tr>
					<th>Ped Bling</th>
                    <th class="dados-extras d-none">Estq Agas</th>
                    <th class="dados-extras d-none">Carga</th>
                    <th>Orc Biv</th>
                    <th>Nome Cliente</th>
                    <th>Emissão</th>
					<th>Entrega</th>
        ...
        foreach ($pedido_vendas_array as $key_ped => $value_ped) {
            ...
            if ($imprimi_item_carteira and $filtro_por_produto == $value_ped['item_ref']) {
                $carteira_processada .= '
                    ...
                    <td class="dados-extras d-none"><input type="checkbox" id="estq_agas" name="estq_agas" value="1"></td>
                    <td class="dados-extras d-none"><input type="checkbox" id="carga" name="carga" value="1"></td>
                    ...
                    <td class="dados-extras d-none">' . exibirValor(($item_valor_cipi / ($value_ped['ped_totalvenda'] - $value_ped['ped_valorfrete']))*$value_ped['ped_valorfrete']) . '</td> 
...
if ($imprimi_apenas_resumo_ref or $atualiza_estoque_biv) {
    $carteira_processada = '';
}
// ================= Consulta de Disponibilidade de Esoque  ============================
if ($pesquisa_por_produto <> '' AND !$atualiza_estoque_biv) {
...
// echo $carteira_processada;
echo 'fim do processamento - estoque';
//fim do cronometro
$fim2 = microtime(true);
