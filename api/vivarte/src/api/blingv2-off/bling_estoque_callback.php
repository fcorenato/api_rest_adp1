        ...
        if (strlen($json_params) > 0 && isValidJSON($json_params)) {
            ...
            foreach ($dados->retorno->estoques[0]->estoque->depositos as $dep) {
                ...
                //if ($deposito_id == '11919578899') {
                    ...
                    $remove_ref_saldo_antigo = mysql_query("DELETE FROM `md_estoque_bling` WHERE referencia = '$ref_prod' and deposito_id = '$deposito_id'") or die(mysql_error());


                    $result = mysql_query("INSERT INTO md_estoque_bling (referencia, descricao, un, deposito_id, deposito, saldo, saldo_disp, json ) VALUES ('$ref_prod', '$ref_desc', ' ', '$deposito_id', '$deposito_nome', '$saldo','$saldo_disp', 'json recebido - $json_receive_at')") or die(mysql_error());
                //}
