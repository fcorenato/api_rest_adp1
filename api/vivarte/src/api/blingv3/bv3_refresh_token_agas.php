...
$query1 = "SELECT bling_credenciais, bling_access_token, bling_refresh_token FROM `sys_unidades` WHERE codigo = 2";
...
if ($resultado->error) {
    ...
    $atu_pv_ibge = mysql_query("UPDATE sys_unidades SET bling_access_token='$tk', bling_refresh_token='$tk_refresh', bling_token_update = '$time_update'  WHERE codigo = 2");
}
