...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  //gerando relatório
  $query1 = "
          select $col1, A3_UNIDAD, $col2, $col3, $col4, B1_DESC, B1_UM, BM_DESC, SUM(SC6.C6_QTDVEN) AS QTDV,  
          ...
          AND SE4.D_E_L_E_T_ = ''
          AND SF4.D_E_L_E_T_ = ''
          GROUP BY $col1, A3_UNIDAD, $col2, $col3, $col4, B1_DESC, B1_UM, BM_DESC 
          $tipo_rel_orderby
          ";
      ...
      if ($campos[$col1] != $subtotal_rel and $subtotal_rel != "inicial") {
        $resultado_rel .= '
          <tr class="'.$bg_subtotal.' tr_result">
              <td colspan="7">TOTAL ' . $subtotal_rel . '</td>
