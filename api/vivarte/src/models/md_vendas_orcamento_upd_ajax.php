...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //registrand evento alteração de total da oportunidade e da alteracao do orcamento
    $oportunidade_id = $ID_OPT;
    $desc_evento .= '<i class="fas fa-caret-right"></i> Orçamento modificado nº: ' . $ID . ' - Valor: R$ '.number_format($totalgeral_final, 2, ',', '.').'<br>';
    ...
    (oportunidade_id, created_at, etapa_id, usuario_id, descricao, acao, acao_data, acao_status, status) VALUES ('$oportunidade_id', '$orc_updated_at', '$etapa_atual', '$usuario_codigo', '$desc_evento', '', '', '', 'A')";
