...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query2 = "
        SELECT codigo, descricao FROM md_vendas_cpgto
        WHERE status = 'A'
          ";
    ...
    if ($qtde_query2 > 0) {
        while ($campos = mysql_fetch_array($result_query2)) {
            $cpag_array[$campos['codigo']] = $campos['descricao'];
        }
    }
