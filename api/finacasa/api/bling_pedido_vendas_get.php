...
$status_pedido = 'idSituacao[6,15,10928,127084]';
        ...
        */
            ...
            */
                $pedido_vendas_array_api[] = array(
                    ...
                    'doc' => '',
                    'saldo_est' => '',
                    'ped_obs_interna' => $ped->pedido->observacaointerna
                );

                //array com refencias da carteira
                $cod_itens_carteira_array[trim($item->item->codigo)]=1;
            }
...
/*
//chamdada api prod_estoque por referencia get
$is = 1;
foreach ($cod_itens_carteira_array as $key => $value) {
    include('bling_prod_estoque_porref_get.php');
    //echo $key.' - '.$is.'<br>';
    //$is++;
}
//echo'<hr> FINAL <hr>';
