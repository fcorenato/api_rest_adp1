...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($DOC_ACAO == 'CONVERTER') {
        ...
        */
        ...
        //chamada API para integração protheus
        ...
        $aviso_check = $CHECKBOX_AVISO_DESBLOQ == 'CHECADO'? ' - Obs: Aviso desbloqueio checado' : '';
        $DESCRICAO =$MOTIVO_DESCRICAO . $aviso_check;
        $result = mysql_query("UPDATE md_vendas_pedidos SET
    ...
    } else if ($DOC_ACAO == 'ATUPARCEIRO') {
        $result = mysql_query("UPDATE md_vendas_pedidos SET
            vend2 = '$C5_VEND2', status='P' WHERE id = $ID_ORC") or die(mysql_error());
