...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  //gerando relatório
  $query1 = "SELECT un.descricao as un_nome,pv.vend2, vend.nome_completo, pv.cliente_razao, pvi.codigo, pvi.descricao, pvi.unidade, pvi.ipi, pv.frete_valor, pv.orc_split_pgto, pv.id as pednum, pv.pedido_conv_date, pvi.qtde, pvi.prc_tab, pvi.desconto, pv.total_cimp, pv.pedido_conv_user, vendc.nome_completo as vend_interno, pvi.app_tx_pal, pvi.taxaPalletAbertoR, pvi.taxaPalletAberto, pvi.precoProdPalletAbertoR
          ...
          AND pvi.status = 'A'
          AND vend.perfil = 'P'
          order by pv.vend2, pv.cliente_razao
