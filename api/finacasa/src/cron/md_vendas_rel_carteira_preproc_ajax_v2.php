...
if ($processar_carteira) {
    ...
    if ($api_qtde_pedido == 0) {
        ...
        //CARGAS SE PRECISAR AVIVAR NAO PODE LIMPAR TABELA E TEM QUE ATUALIZAR ITENS FATURADOS
...
// se atualizar estoque no biv FINACASA ===================================================
...
// se atualizar estoque no biv FINACASA CORES ===================================================
$atualiza_estoque_biv = TRUE;
if ($atualiza_estoque_biv) {
